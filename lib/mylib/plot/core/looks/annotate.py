...
def annotate_theta_accept(xlim:tuple):
    ...
    plt.axhline(y=500, xmin=one_scale(radians(25)), xmax=one_scale(radians(40)), color="tan", linestyle=":")
    plt.axhline(y=500, xmin=one_scale(radians(129)), xmax=one_scale(radians(155)), color="tan", linestyle=":")
