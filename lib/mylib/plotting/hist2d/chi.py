...
def hist_2d_chi_theta_k(data, out_dir, q_squared_split):
    ...
    save("hist2d_chi_theta_k", q_squared_split, out_dir)


@over_q_squared_splits
def hist_2d_chi_p_k(data, out_dir, q_squared_split):
    fig, axs = plot_hist_2d(
        data,
        var_x="chi",
        var_y="K_p_p",
    ...
    save("hist2d_chi_p_k", q_squared_split, out_dir)
